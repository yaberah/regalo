      ...
      <Layout>
        <Subpage title="メニュー" enTitle="Menu">
          <section className="sub">
            ...
            <h3>⭐️LINE友達追加特典⭐️</h3>
            <p>初回体験  ¥1,000 （約90分）<br />※定期チェックコースに準じた内容</p>

            <h3>月額コースメニュー</h3>
            <h4>オンラインコース</h4>
            <p>月1回　¥3,000<br />オンラインでのトレーニング提供（約60分/回）</p>
            <h4>定期チェックコース</h4>
            <p>月1回　¥5,000<br />身体評価、施術、自主トレ提供（約90分/回）</p>
            <h4>チャレンジコース⭐️オススメ</h4>
            <p>月2回　¥10,000<br />身体評価、施術、自主トレ提供（約120分/回）</p>
            <h4>コミットコース</h4>
            <p>月2回　¥20,000<br />カウセリング、ボディチェック、月2回施術、自主トレ提供、パーソナル動画提供、競技動作評価などなど（約120分/回）</p>
